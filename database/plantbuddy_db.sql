...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2025 at 03:24 PM
...
ALTER TABLE `schedules`
  ...
  ADD CONSTRAINT `schedules_ibfk_2` FOREIGN KEY (`plant_id`) REFERENCES `plants` (`id`) ON DELETE CASCADE;
COMMIT;
